...
export class TagSettingsApp extends HandlebarsApplicationMixin(ApplicationV2) {
  ...
  async _onRender(context, options) {
    ...
    this.element.querySelector("[data-action='add-tag']")
    ...
    this.element.querySelector("[data-action='save-tags']")
  ...
  async #addTag() {
    ...
    await TagService.create({
      name: game.i18n.localize("TIMELINE_NOTES.TagSettings.NewTagName"),
      color: "#888888"
    });
